  ...
  return (
    <>
      <Stack className="bg-white_A700 font-nunitosans h-[900px] mx-[auto] relative w-[100%]">
        <Stack className="absolute bottom-[0] h-[3755px] w-[100%]">
          <Stack className="absolute h-[3660px] top-[3%] w-[100%]">
            <Stack className="absolute h-[3659px] top-[0] w-[100%]">
              ...
              <Img
                ...
                className="absolute h-[700px] max-w-[100%] top-[0] w-[100%]"
                alt="BGAeoFlgt"
              />
            </Stack>
            <Column className="absolute flex flex-col items-center justify-start md:p-[48px] p-[93px] sm:px-[15px] sm:py-[37px] w-[100%]">
              <Img
        ...
        <Row className="absolute bg-indigo_A200 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end p-[13px] sm:p-[5px] md:p-[6px] top-[0] w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between max-w-[1677px] sm:mx-[0] my-[3px] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Text
