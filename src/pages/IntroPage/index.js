...
const IntroPagePage = () => {
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] pb-[14px] sm:pb-[5px] md:pb-[7px] w-[100%]">
        <Stack className="h-[796px] relative w-[100%]">
          <Stack className="absolute bottom-[0] h-[701px] w-[100%]">
            <Img
              src="images/img_bgaeoflgt.png"
              className="absolute h-[700px] max-w-[100%] top-[0] w-[100%]"
              alt="BGAeoFlgt"
            />
            <Column className="absolute bottom-[0] flex flex-col items-center justify-start md:p-[48px] p-[93px] sm:px-[15px] sm:py-[37px] w-[100%]">
              <Img
