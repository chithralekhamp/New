  ...
  return (
    <>
      <Stack className="bg-white_A700 font-nunitosans h-[900px] mx-[auto] relative w-[100%]">
        <Stack className="absolute bottom-[0] h-[2820px] left-[0] max-w-[1841px] sm:pl-[15px] sm:pr-[15px] pr-[4px] py-[4px] w-[100%]">
          <Stack className="absolute h-[2595px] left-[0] top-[1%] sm:w-[100%] w-[92%]">
            ...
            <Stack className="absolute h-[2595px] sm:pb-[167px] md:pb-[216px] pb-[420px] w-[100%]">
              ...
              >
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mb-[153px] md:mb-[197px] mb-[383px] md:ml-[172px] ml-[335px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[13%]">
                  <Img
          ...
          <Stack className="absolute h-[96px] md:p-[10px] p-[21px] sm:px-[15px] sm:py-[8px] sm:w-[100%] w-[66%]">
            <Img
              src="images/img_menu.svg"
              className="absolute h-[32px] inset-y-[0] left-[22%] max-w-[100%] my-[auto] rounded-radius4 sm:w-[12px] md:w-[16px] w-[32px]"
              alt="menu"
            />
          </Stack>
        </Stack>
