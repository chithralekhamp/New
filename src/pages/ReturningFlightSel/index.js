      ...
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[15px] md:mt-[20px] mt-[40px] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1471px] md:ml-[124px] ml-[auto] mr-[auto] md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[60%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[81%]">
                  <SelectBox
                ...
                <Column className="border border-indigo_50 border-solid flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] pt-[16px] sm:pt-[6px] md:pt-[8px] sm:px-[15px] px-[16px] md:px-[8px] rounded-radius12 w-[100%]">
                    ...
                    <div className="overflow-x-auto w-[100%]">
                      <Stack className="h-[440px] relative rounded-radius8 w-[100%]">
                        ...
                        <Column className="absolute flex flex-col items-center justify-start top-[0] w-[100%]">
                          <Row className="bg-gray_51 border border-indigo_A200 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center p-[4px] rounded-radius4 w-[100%]">
                            <Img
                            ...
                            <Column className="flex flex-col items-center md:ml-[4px] ml-[8px] sm:mx-[0] md:p-[4px] p-[8px] sm:px-[0] sm:py-[3px] sm:w-[100%] w-[92%]">
                              ...
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[98%]">
                                ...
                                <Text
                                  className="font-normal sm:ml-[25px] md:ml-[32px] ml-[63px] not-italic text-bluegray_400 w-[auto]"
                                  as="h3"
                                  variant="h3"
                                >
                                  value
                                ...
                                <Text
                                  className="font-normal md:ml-[102px] ml-[198px] sm:ml-[79px] not-italic text-bluegray_400 w-[auto]"
                                  as="h3"
                                  variant="h3"
                                >
                                  2h 45m in HNL
              ...
              <Column className="flex flex-col md:ml-[102px] ml-[199px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[28%]">
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[56%] ml-[172px] sm:ml-[68px] md:ml-[88px] sm:mr-[2px] md:mr-[3px] mr-[6px] sm:mt-[24px] md:mt-[32px] mt-[62px] not-italic text-[18px] text-center text-gray_50 w-[max-content]"
                  shape="RoundedBorder4"
                  variant="FillIndigoA200"
                >
            ...
            <List
              className="gap-[0] grid max-w-[1641px] min-h-[auto] sm:ml-[65px] md:ml-[84px] ml-[auto] mr-[auto] sm:mt-[15px] md:mt-[20px] mt-[40px] sm:pl-[15px] sm:pr-[15px] w-[100%]"
            ...
            <footer className="bg-white_A700 sm:mt-[16px] md:mt-[21px] mt-[41px] w-[100%]">
...
export default ReturningFlightSelPage;
