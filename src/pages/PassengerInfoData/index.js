...
import { Column, Row, Text, Button, Input, Img, Line, Stack } from "components";

const PassengerInfoDataPage = () => {
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] sm:pb-[3px] md:pb-[4px] pb-[8px] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[22px] md:mt-[28px] mt-[56px] w-[100%]">
            <Text
            ...
            <Text
              className="font-semibold ml-[158px] sm:ml-[63px] md:ml-[81px] sm:mt-[14px] md:mt-[18px] mt-[36px] text-bluegray_500 w-[auto]"
              as="h2"
              variant="h2"
            >
              Passenger 1 (Adult)
            </Text>
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between max-w-[1555px] md:ml-[81px] ml-[auto] mr-[auto] md:mt-[11px] mt-[23px] sm:mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1548px] md:ml-[81px] ml-[auto] mr-[auto] md:mt-[10px] mt-[21px] sm:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[2px] md:mt-[3px] mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[12%]">
                ...
                <Text
                  className="font-normal sm:ml-[3px] md:ml-[4px] ml-[8px] not-italic text-bluegray_500 w-[auto]"
                  as="h3"
                  variant="h3"
                >
                  Same as Passenger 1
              ...
              <Button
                className="cursor-pointer font-normal min-w-[9%] not-italic text-[18px] text-center text-gray_50 w-[max-content]"
                shape="RoundedBorder4"
                variant="FillIndigoA200"
              >
                Select seats
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[624px] md:ml-[81px] ml-[auto] mr-[auto] sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Input
                className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 w-[100%]"
                wrapClassName="sm:mx-[0] sm:w-[100%] w-[49%]"
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1537px] md:ml-[81px] ml-[auto] mr-[auto] md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[45%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[14px] md:mt-[18px] mt-[36px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[59%]">
                  <Text
                  ...
                  <Text
                    className="font-semibold ml-[180px] sm:ml-[71px] md:ml-[92px] text-bluegray_400 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
                    Checked bags
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[59%]">
                  <Text
                    className="font-semibold mb-[1px] sm:mt-[2px] md:mt-[3px] mt-[6px] text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
                    Sophia Knowles
                  </Text>
                  <Stack className="bg-gray_50 h-[32px] ml-[148px] sm:ml-[59px] md:ml-[76px] relative rounded-radius4 sm:w-[12px] md:w-[16px] w-[32px]">
                    <Img
                  ...
                  <Text
                    className="font-normal md:ml-[12px] ml-[24px] sm:ml-[9px] sm:my-[2px] md:my-[3px] my-[6px] not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
                    1
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[29px] md:mt-[38px] mt-[74px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                  ...
                  <Button
                    className="cursor-pointer font-normal min-w-[43%] md:ml-[12px] ml-[24px] sm:ml-[9px] not-italic text-[18px] text-center text-gray_50 w-[max-content]"
                    shape="RoundedBorder4"
                    variant="FillIndigoA200"
                  >
                    Select seats
            ...
            <footer className="bg-white_A700 sm:mt-[19px] md:mt-[24px] mt-[48px] w-[100%]">
...
export default PassengerInfoDataPage;
