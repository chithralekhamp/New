      ...
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[15px] md:mt-[20px] mt-[40px] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1275px] md:ml-[124px] ml-[auto] mr-[auto] sm:mt-[19px] md:mt-[24px] mt-[48px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Text
              ...
              <Text
                className="font-semibold sm:ml-[344px] md:ml-[444px] ml-[862px] text-bluegray_500 w-[auto]"
                as="h2"
                variant="h2"
              >
                <span className="text-bluegray_500 text-[18px] font-nunitosans">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1471px] md:ml-[124px] ml-[auto] mr-[auto] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
                    ...
                    <div className="overflow-x-auto w-[100%]">
                      <Stack className="h-[440px] relative rounded-radius8 w-[100%]">
                        ...
                        <Column className="absolute flex flex-col items-center justify-start top-[0] w-[100%]">
                          <Row className="bg-gray_51 flex flex-row md:flex-wrap sm:flex-wrap items-center p-[4px] rounded-radius4 w-[100%]">
                            <Img
              ...
              <Column className="flex flex-col items-center md:ml-[102px] ml-[199px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[28%]">
                <Column className="flex flex-col justify-start sm:px-[0] w-[100%]">
                  ...
                  >
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly my-[0] sm:px-[0] w-[100%]">
                      ...
                      <Button
                        className="cursor-pointer font-bold min-w-[17%] text-[12px] text-bluegray_700 text-center w-[max-content]"
                        size="lg"
                      >
                        2/12
                      </Button>
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1471px] md:ml-[124px] ml-[auto] mr-[auto] sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <div className="mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] overflow-x-auto sm:px-[0] sm:w-[100%] w-[60%]">
              ...
              <Column className="flex flex-col justify-start md:ml-[102px] ml-[199px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[28%]">
                ...
                >
                  ...
                  <span className="text-indigo_200 text-[16px] font-nunitosans">
                    AeolusFlights analyzes thousands of flights, prices, and
                    trends to ensure you get the best deal.
                  </span>
                </Text>
              </Column>
            </Row>
            <List
              className="gap-[16px] sm:gap-[6px] md:gap-[8px] grid max-w-[1639px] min-h-[auto] sm:ml-[60px] md:ml-[78px] ml-[auto] mr-[auto] md:mt-[11px] mt-[22px] sm:mt-[8px] sm:pl-[15px] sm:pr-[15px] w-[100%]"
              orientation="vertical"
            >
              ...
              <Line className="self-center w-[54%] sm:w-[100%] sm:mx-[0] outline-bluegray_100 outline-[1px] outline bg-white_A700 shadow-bs2 items-center flex-row flex rounded-radius4" />
              <Column className="flex flex-col items-center justify-start sm:p-[15px] md:p-[20px] p-[40px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
                  <Text
                    className="font-bold text-bluegray_500 w-[auto]"
            ...
            <footer className="bg-white_A700 sm:mt-[17px] md:mt-[22px] mt-[43px] w-[100%]">
...
export default HoverReturningFltPage;
