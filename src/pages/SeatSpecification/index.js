...
const SeatSpecificationPage = () => {
  return (
    <>
      <Stack className="bg-white_A700 font-nunitosans h-[900px] mx-[auto] relative w-[100%]">
        <Column className="absolute bottom-[0] flex flex-col justify-start left-[0] max-w-[1827px] sm:pl-[15px] sm:pr-[15px] pr-[4px] py-[4px] w-[100%]">
          <Stack className="h-[96px] md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] relative sm:w-[100%] w-[66%]">
            <Img
          ...
          <Stack className="h-[2595px] mb-[180px] sm:mb-[71px] md:mb-[92px] mt-[11px] sm:mt-[4px] md:mt-[5px] relative sm:w-[100%] w-[92%]">
            ...
            <Stack className="absolute h-[2595px] sm:pb-[167px] md:pb-[216px] pb-[420px] w-[100%]">
              ...
              >
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mb-[124px] md:mb-[161px] mb-[312px] md:ml-[165px] ml-[321px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[13%]">
                  <Img
              ...
              <Column
                className="absolute bg-cover bg-no-repeat flex flex-col items-center justify-start left-[30%] sm:mx-[0] sm:p-[3px] md:p-[4px] p-[9px] top-[11%] sm:w-[100%] w-[14%]"
            ...
            <Column className="flex flex-col items-center overflow-auto sm:px-[0] w-[100%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:p-[3px] md:p-[4px] p-[8px] w-[100%]">
                <Column className="flex flex-col items-center justify-center ml-[10px] md:ml-[5px] sm:mx-[0] md:p-[4px] p-[8px] sm:px-[0] sm:py-[3px] rounded-radius8 sm:w-[100%] w-[49%]">
                  <Img
                    src="images/img_economyseats_3.svg"
                ...
                <Column className="flex flex-col items-center justify-center sm:mb-[27px] md:mb-[36px] mb-[70px] ml-[4px] sm:mx-[0] md:p-[4px] p-[8px] sm:px-[0] sm:py-[3px] rounded-radius8 sm:w-[100%] w-[49%]">
                  <Img
                    src="images/img_businessseats_3.svg"
                    className="max-w-[100%] md:mt-[12px] mt-[24px] sm:mt-[9px] w-[100%]"
                    alt="BusinessSeats"
                  />
                  <Column className="flex flex-col justify-start md:mb-[12px] mb-[24px] sm:mb-[9px] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[85%]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[75%]">
                      ...
                      <Text
                        className="bg-gradient3  font-bold ml-[16px] sm:ml-[6px] md:ml-[8px] sm:px-[2px] md:px-[3px] px-[6px] py-[2px] rounded-radius4 text-white_A700 w-[auto]"
                        as="h4"
                        variant="h4"
                      >
                        Selected
...
export default SeatSpecificationPage;
