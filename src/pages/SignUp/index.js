  ...
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-end mx-[auto] w-[100%]">
        ...
        <Stack className="h-[790px] mt-[2px] relative w-[100%]">
          <Stack className="absolute h-[790px] w-[100%]">
            <Stack className="absolute bottom-[0] h-[700px] w-[100%]">
              <Img
                src="images/img_bgaeoflgt_700X1918.png"
                className="absolute h-[700px] left-[0] max-w-[100%] w-[100%]"
                alt="BGAeoFlgt"
              />
              <Column className="absolute bg-bluegray_700_33 flex flex-col items-center justify-start sm:p-[15px] md:p-[48px] p-[93px] w-[100%]">
                <Column className="flex flex-col items-center justify-start mb-[152px] sm:mb-[60px] md:mb-[78px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[70%]">
                  <Img
                    src="images/img_herotextgradi.png"
                    className="max-w-[100%] sm:w-[100%] w-[63%]"
                    alt="HeroTextGradi"
                  />
                  <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly sm:mt-[19px] md:mt-[24px] mt-[48px] outline outline-[1px] outline-bluegray_100 rounded-radius4 shadow-bs1 w-[100%]">
                    <List
            ...
            <Column className="absolute bg-white_A700 flex flex-col items-end justify-start p-[1px] top-[0] w-[100%]">
          ...
          <Column className="absolute bg-white_A700 border border-bluegray_100 border-solid bottom-[3%] flex flex-col inset-x-[0] items-center justify-start sm:mx-[0] mx-[auto] sm:p-[15px] md:p-[20px] p-[40px] rounded-radius12 shadow-bs1 sm:w-[100%] w-[30%]">
            <Column className="flex flex-col items-center justify-start sm:px-[0] w-[100%]">
              ...
              <Text
                ...
                variant="h2"
              >
                Aeolus Flights is totally free to use. Sign up using your email
                address or phone number below to get started.
              </Text>
            </Column>
            <Input
              className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_400 text-bluegray_400 w-[100%]"
              wrapClassName="md:mt-[10px] mt-[20px] sm:mt-[7px] w-[100%]"
              type="email"
              name="basetextin"
            ...
            <Input
              className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_400 text-bluegray_400 w-[100%]"
              wrapClassName="md:mt-[6px] mt-[12px] sm:mt-[4px] w-[100%]"
              type="password"
              name="basetextin One"
              placeholder="Password"
            ></Input>
            <Column className="flex flex-col items-center justify-start mt-[12px] sm:mt-[4px] md:mt-[6px] sm:px-[0] w-[100%]">
              <CheckBox
            ...
            <Button
              className="cursor-pointer font-normal min-w-[100%] mt-[12px] sm:mt-[4px] md:mt-[6px] not-italic text-[18px] text-center text-gray_50 w-[max-content]"
              shape="RoundedBorder4"
              variant="FillIndigoA200"
            >
              Create account
            </Button>
            <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[20px] sm:mt-[7px] pt-[12px] sm:pt-[4px] md:pt-[6px] sm:px-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between w-[100%]">
                <Line className="bg-bluegray_100 h-[1px] sm:my-[3px] md:my-[4px] my-[8px] sm:w-[100%] w-[47%]" />
                <Text
                  className="font-normal not-italic text-bluegray_400 w-[auto]"
                  as="h2"
                  variant="h2"
              ...
              <Row
                className="common-pointer border border-indigo_A200 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[11px] mt-[22px] sm:mt-[8px] p-[11px] sm:p-[4px] md:p-[5px] rounded-radius4 w-[100%]"
              ...
              >
                ...
                />
                <Text
                  className="flex-grow font-normal ml-[118px] sm:ml-[47px] md:ml-[60px] not-italic text-indigo_A200"
                  as="h2"
                  variant="h2"
                >
        ...
        <footer className="bg-bluegray_700_33 sm:mt-[17px] md:mt-[22px] mt-[44px] w-[100%]">
