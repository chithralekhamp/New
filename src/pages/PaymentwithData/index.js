...
import { Column, Row, Text, Button, Img, Input, Line } from "components";
import { useGoogleLogin } from "@react-oauth/google";

const PaymentwithDataPage = () => {
    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-end mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-end w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[19px] md:mt-[25px] mt-[50px] w-[100%]">
            <Text
              className="font-bold ml-[158px] sm:ml-[63px] md:ml-[81px] text-indigo_A200 w-[auto]"
              as="h1"
              variant="h1"
            >
              Payment method
            </Text>
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1555px] md:ml-[81px] ml-[auto] mr-[auto] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              ...
              <Column className="flex flex-col items-end justify-start sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between max-w-[1541px] md:ml-[81px] ml-[auto] mr-[auto] mt-[10px] sm:mt-[3px] md:mt-[5px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Text
                className="font-semibold sm:mt-[11px] md:mt-[15px] mt-[30px] text-bluegray_500 w-[auto]"
                as="h2"
                variant="h2"
              >
                Create an account
              ...
              <Button
                className="cursor-pointer font-normal mb-[2px] min-w-[12%] not-italic text-[18px] text-center text-gray_50 w-[max-content]"
                shape="RoundedBorder4"
                variant="FillIndigoA200"
              >
                Confirm and pay
            ...
            <Text
              className="font-normal leading-[normal] ml-[158px] md:ml-[81px] md:mt-[10px] mt-[20px] sm:mt-[7px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[36%]"
              as="h3"
              variant="h3"
            >
              AeolusFlights is free to use as a guest, but if you create an
              account today, you can save and view flights, manage your trips,
              earn rewards, and more.
            </Text>
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[294px] md:ml-[81px] ml-[auto] mr-[auto] sm:mt-[11px] md:mt-[14px] mt-[28px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="border border-bluegray_500 border-solid flex flex-col h-[16px] sm:h-[7px] md:h-[9px] items-center justify-start mt-[3px] px-[4px] rounded-radius2 w-[16px] sm:w-[6px] md:w-[8px]">
                <div className="bg-indigo_A200 sm:h-[4px] md:h-[5px] h-[8px] rounded-radius1 sm:w-[3px] md:w-[4px] w-[8px]"></div>
              </Column>
              <Text
                className="font-normal mb-[1px] sm:ml-[3px] md:ml-[4px] ml-[8px] not-italic text-bluegray_500 w-[auto]"
                as="h3"
                variant="h3"
              >
            ...
            <Input
              className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 w-[100%]"
              wrapClassName="md:ml-[81px] md:mt-[16px] ml-[158px] mt-[31px] sm:mt-[12px] sm:mx-[0] sm:w-[100%] w-[25%]"
              type="email"
              name="email"
              placeholder="sophiaknowles89@tripma.com"
            ></Input>
            <Column className="flex flex-col items-center justify-start max-w-[480px] md:ml-[81px] ml-[auto] mr-[auto] md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Input
                className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 w-[100%]"
            ...
            <Column className="flex flex-col items-center justify-start max-w-[488px] md:ml-[81px] ml-[auto] mr-[auto] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            ...
            <Text
              className="font-semibold ml-[158px] sm:ml-[63px] md:ml-[81px] sm:mt-[19px] md:mt-[24px] mt-[48px] text-bluegray_500 w-[auto]"
              as="h2"
              variant="h2"
            >
              Cancellation policy
            ...
            <Text
              className="font-normal leading-[normal] ml-[158px] md:ml-[81px] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[36%]"
              as="h3"
              variant="h3"
            >
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[388px] md:ml-[81px] ml-[auto] mr-[auto] sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Button
              ...
              <Button
                className="cursor-pointer font-normal min-w-[45%] md:ml-[12px] ml-[24px] sm:ml-[9px] not-italic text-[18px] text-center text-gray_50 w-[max-content]"
                shape="RoundedBorder4"
                variant="FillIndigoA200"
              >
                Confirm and pay
            ...
            <footer className="bg-white_A700 mt-[113px] sm:mt-[45px] md:mt-[58px] w-[100%]">
...
export default PaymentwithDataPage;
