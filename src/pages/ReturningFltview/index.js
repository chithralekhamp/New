      ...
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[15px] md:mt-[20px] mt-[40px] w-[100%]">
            ...
            <List
              className="sm:gap-[11px] md:gap-[14px] gap-[29px] grid max-w-[1662px] min-h-[auto] sm:ml-[57px] md:ml-[74px] ml-[auto] mr-[auto] md:mt-[11px] mt-[22px] sm:mt-[8px] sm:pl-[15px] sm:pr-[15px] w-[100%]"
              orientation="vertical"
            >
              <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:p-[15px] md:p-[20px] p-[40px] sm:w-[100%] w-[98%]">
            ...
            <footer className="bg-white_A700 sm:mt-[11px] md:mt-[15px] mt-[30px] w-[100%]">
