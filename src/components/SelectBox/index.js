...
const sizes = {
  ...
  md: "pb-[11px] sm:pb-[4px] md:pb-[5px] sm:pt-[3px] md:pt-[4px] pt-[8px] sm:px-[3px] md:px-[4px] px-[8px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#605dec",
              "&:hover": { backgroundColor: "#605dec", color: "#fafafa" },
            }),
